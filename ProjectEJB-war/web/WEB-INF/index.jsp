...
<c:if test="${!empty language}">
    <c:set var="javax.servlet.jsp.jstl.fmt.locale.session" value="${language}" scope="session"/>
</c:if>
...
<body class="common-home">
	...
	<div class="container">
		<div id="content" class="row">
            ...
            <h3><fmt:message bundle="${bundle}"  key="index.featured" /></h3>
			...
			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
				<div class="product-thumb transition">
					...
					<div class="button-group">
						<button style="width: 100%" type="button" onclick="cart.add('${bean.id}');"><i class="fa fa-shopping-cart"></i> <span class="hidden-xs hidden-sm hidden-md"><fmt:message bundle="${bundle}" key="index.addToCart" /></span></button>
					</div>
				</div>
			</div>
				</c:forEach>
